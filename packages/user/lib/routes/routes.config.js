...
} = require("../security/authorization/authorization.permission");
...
exports.routesConfig = (app) => {
  ...
  app.delete("/users/:userId/privacy", [
    Validator.validJWTNeeded,
    onlySameUserOrAdminCanDoThisAction,
    IdentityProvider.clearPrivacyData,
  ]);
  ...
  app.patch("/availability/defaultMessages", [
    minimumPermissionLevelRequired(Master),
    AvailabilityProvider.updateDefaultMessage,
  ]); // Update the default
