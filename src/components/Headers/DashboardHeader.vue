			...
			<a-row type="flex">
				...
				<a-col :span="24" :md="18" class="header-control">
					...
					<a-dropdown :trigger="['click']" overlayClassName="header-notifications-dropdown"
						...
						<a-list item-layout="horizontal" class="header-notifications-list"
							:data-source="notificationsData" slot="overlay">
							<a-list-item slot="renderItem" slot-scope="item">
								<a-list-item-meta>
									...
									<a-avatar v-else shape="square" slot="avatar" :src="item.svg" />
					...
					<a-button type="link" @click="signOut">
						<svg fill="#000000" width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M2.293,11.293l4-4A1,1,0,1,1,7.707,8.707L5.414,11H17a1,1,0,0,1,0,2H5.414l2.293,2.293a1,1,0,1,1-1.414,1.414l-4-4a1,1,0,0,1,0-1.414ZM20,4V20a1,1,0,0,0,2,0V4a1,1,0,0,0-2,0Z"/></svg>
						<span>Sign out</span>
					</a-button>
					<!-- / Header Control Buttons -->
